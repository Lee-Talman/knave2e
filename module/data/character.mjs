...
export default class Knave2eCharacter extends Knave2eActorType {
    ...
    static defineSchema() {
        ...
        schema.armorPoints = new fields.NumberField({ ...requiredInteger, initial: 0 });
        ...
        schema.slots = new fields.SchemaField({
            ...
            max: new fields.NumberField({ required: true, nullable: false, integer: false, initial: 10, min: 0, step: 0.01 })
        });
