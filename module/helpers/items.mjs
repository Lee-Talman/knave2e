  ...
  // Roll with abilities for characters
    ...
    attackRollBonus =
      itemData.category === "melee"
        ? systemData.abilities.strength.value
        : systemData.abilities.wisdom.value;
  }
      ...
      if (powerAttack) {
        ...
        if (
          ...
          if (itemData.broken) {
            ...
            rollFlavor =
              rollFlavor +
              `. ${game.i18n.localize("KNAVE2E.PowerAttack")} ${game.i18n.localize("KNAVE2E.Breaks")} one of ${this.actor.name}'s ${
                item.name
              }s!`;
          }
        }
